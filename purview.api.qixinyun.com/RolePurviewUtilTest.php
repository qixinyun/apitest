...
// $response = $client->request('GET', 'rolePurviews?filter[roleId]=1,2,3,6,5',['haders'=>['Content-' => 'application/vnd.api+json']]);
$response = $client->request('GET', 'rolePurviews?filter[roleId]=1',['haders'=>['Content-' => 'application/vnd.api+json']]);
