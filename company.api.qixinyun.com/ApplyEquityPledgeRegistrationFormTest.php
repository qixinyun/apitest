...
// $response = $client->request('GET', 'applyEquityPledgeRegistrationForms/1,2',['haders'=>['Content-' => 'application/vnd.api+json']]);
...
$response = $client->request(
                'PUT',
                'applyEquityPledgeRegistrationForms/12/decline',
                [
                'haders'=>['Content-Type' => 'application/vnd.api+json']
                ]
            );
...
/*$response = $client->request(
                'PUT',
                'applyEquityPledgeRegistrationForms/11/approve',
                [
                'haders'=>['Content-Type' => 'application/vnd.api+json']
                ]
            );*/
